...
def stdv1_5(pprompt, nprompt, filter, cfg, steps):
    ...
    def uniquify(path):
        ...
        return path
    prompt = pprompt#+", (masterpiece:1.2), best quality, ultra-detailed, illustration, portrait"
    negative_prompt = nprompt#+"badhandv4,(worst quality:1.6),(low quality:1.6),  easynegative"
    global ckpt_path, vae_repo
    if filter=="PastelMix":        
        ...
        ckpt_path = r"Stable-diffusion\ghibli-diffusion-v1.ckpt"
        vae_repo = "lint/anime_vae"
